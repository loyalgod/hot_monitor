...
实测在代码审查场景中，Sonnet 4.6 比 GPT-4 快 30%。`,
  ...
  },
  {
    ...
    keyword: 'AI 导航',
    content: `某知名 AI 导航网站上线了全新的分类功能，新增了 50+ AI 工具推荐。
站长表示，AI 导航将持续更新，帮助开发者快速找到最合适的 AI 工具。
新版本还支持用户收藏和评分功能。`,
    expectPass: true,
    expectKeywordMentioned: true,
    expectedRelevanceRange: [80, 100],
...
describe('Query Expansion（查询扩展）', () => {
  ...
  it('中文关键词能正确扩展', async () => {
    const result = await expandKeyword('AI 导航');
    expect(result).toContain('AI 导航');
